    ...
    public void onBindViewHolder(@NonNull TopAdapter.ViewHolder holder, int position) {
        ...
        if (category != null) {
            ...
            if (category.getBooks().size() == 3){
                ...
                fillDataToBook(book1, holder.binding.imgBook1, holder.binding.tvName1, holder.binding.tvAuthor1, holder.binding.lnBook1);
                //Book 2
                Book book2 = category.getBooks().get(1);
                fillDataToBook(book2, holder.binding.imgBook2, holder.binding.tvName2, holder.binding.tvAuthor2, holder.binding.lnBook2);
                //Book 3
                Book book3 = category.getBooks().get(2);
                fillDataToBook(book3, holder.binding.imgBook3, holder.binding.tvName3, holder.binding.tvAuthor3, holder.binding.lnBook3);
            }
        }
    }

    private void fillDataToBook(Book book, ImageView imgBook, TextView tvName, TextView tvAuthor, LinearLayout lnBook) {
        //set ảnh book
