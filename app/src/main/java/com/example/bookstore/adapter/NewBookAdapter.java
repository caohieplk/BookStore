...
public class NewBookAdapter extends RecyclerView.Adapter<NewBookAdapter.ViewHolder> {
    ...
    public NewBookAdapter(Context context, List<Book> books, Fragment fragment) {
    ...
    public NewBookAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ItemNewBookBinding itemNewBookBinding = ItemNewBookBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false);
        return new ViewHolder(itemNewBookBinding);
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ItemNewBookBinding binding;

        ViewHolder(ItemNewBookBinding binding) {
